...
class _RobChatPageState extends State<RobChatPage> {
  ...
  void initState() {
    ...
    _messages.add(ChatMessage(
      text: 'Hello! I\'m your fitness assistant. I\'m here to help you with your workout plans, exercise techniques, nutrition advice, and any fitness-related questions. How can I assist you today?',
      isUser: false,
      ...
      final response = await http.post(
        ...
        body: json.encode({
          ...
          'messages': [
            {
              'role': 'system',
              'content': 'You are a professional fitness assistant and workout coach. Your role is to provide helpful advice on exercise, fitness training, nutrition, and health. You should be friendly, encouraging, and knowledgeable. Always respond in English and provide practical, actionable advice.',
            },
            {
              'role': 'user',
              'content': messageText,
